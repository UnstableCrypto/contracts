...
```bash
DEPLOY_CONFIG_PATH=deploy-config/sepolia.json forge script scripts/multiproof/DeployDevNoNitro.s.sol --rpc-url https://sepolia.unstable.org --broadcast --ledger --hd-paths "m/44'/60'/1'/0/0"
```
